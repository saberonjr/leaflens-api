...
model = YOLO("./runs/segment/weights/last.pt")
...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        results = model(image, size=640)  # adjust size according to your needs
        im_bgr = results.render()[0]  # Get rendered image as numpy array
